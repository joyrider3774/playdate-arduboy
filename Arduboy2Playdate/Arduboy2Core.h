...
#define RGB_ON 0   /**< For digitially setting an RGB LED on using digitalWriteRGB() */
#define RGB_OFF 1 /**< For digitially setting an RGB LED off using digitalWriteRGB() */
...
protected:
    ...
    // Playdate
    static LCDBitmap *screenBitmap;
    static uint8_t *buffer;
    static int rowBytes;
    static int dummy;
    static uint8_t *dummy2;
