...
void loadEntity(Entity& entity, EntityType entityType) {
    ...
    entity.tiles = (const uint8_t*)pgm_read_ptr(pStart++);
    entity.updatePtr = (Entity::EntityUpdatePtr)pgm_read_ptr(pStart++);
    entity.collideOtherEntityPtr = (Entity::EntityCollideOtherEntityPtr)pgm_read_ptr(pStart++);
}
