...
static const uint16_t levelComplete[] PROGMEM = {
...
static const uint16_t dead[] PROGMEM = {
...
static const uint16_t score[] PROGMEM = {
  NOTE_REST,500,
