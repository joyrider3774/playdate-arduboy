 ...
 */
inline void EEPROM_Utils::initEEPROM(bool forceClear) {
 ...
 */
inline uint8_t EEPROM_Utils::getGameNumber() {
 ...
 *   Get the current level number. 
 */
inline uint8_t EEPROM_Utils::getLevelNumber() {
 ...
 */
inline uint8_t EEPROM_Utils::getMen() {
 ...
 */
inline void EEPROM_Utils::saveLevelNumber(uint8_t levelNumber) {
 ...
 *   Get saved game data.
 */
inline void EEPROM_Utils::getSavedGameData(Level *level, Player *player) {
 ...
 *   Save game data.
 */
inline void EEPROM_Utils::saveGameData(Level *level, Player *player) {
 ...
 *   Save game number.
 */
inline void EEPROM_Utils::setGameNumber(uint8_t val) {
