...
inline uint8_t Enemy::getId() const {
  return (_flags & 0x0f);
}

inline uint16_t Enemy::getX() const {
  return _x;
}

inline uint16_t Enemy::getY() const {
  return _y;
}

inline int8_t Enemy::getXDelta() const {
  return _xDelta;
}

inline int8_t Enemy::getYDelta() const {
  return _yDelta;
}

inline int8_t Enemy::getXFuturePosition() const {
  return (_futurePosition & 0x0f);
}

inline int8_t Enemy::getYFuturePosition() const {
  return (_futurePosition & 0xF0) >> 4;
}

inline bool Enemy::getEnabled() const {
  return (_flags & 0x10) == 0x10;
}

inline uint8_t Enemy::getGoldCountdown() const {
  return _goldCountdown;
}

inline uint8_t Enemy::getDirectionCountdown() const {
  return _directionCountdown;
}

inline PlayerStance Enemy::getStance() const {
  return _stance;
}

inline EscapeHole Enemy::getEscapeHole() const {
  return _escapeHole;
}

inline Direction Enemy::getDirection() const {
  return _direction;
}

inline Direction Enemy::getPreferredDirection() const {
  return _preferredDirection;
}

inline void Enemy::setId(uint8_t val) {
  _flags = (_flags & 0xf0) | val;
}
    
inline void Enemy::setX(uint16_t val) {
  _x = val;
}

inline void Enemy::setY(uint16_t val) {
  _y = val;
}

inline void Enemy::setXDelta(int8_t val) {
  _xDelta = val;
}

inline void Enemy::setYDelta(int8_t val) {
  _yDelta = val;
}

inline void Enemy::setXFuturePosition(int8_t val) {
  _futurePosition = (_futurePosition & 0xf0) | val;
}

inline void Enemy::setYFuturePosition(int8_t val) {
  _futurePosition = (_futurePosition & 0x0f) | (val << 4);
}

inline void Enemy::setEnabled(bool val) {
  _flags = (_flags | (val ? 0x10 : 0x00));
}

inline void Enemy::setGoldCountdown(uint8_t val) {
  _goldCountdown = val;
}

inline void Enemy::setDirectionCountdown(uint8_t val) {
  _directionCountdown = val;
}

inline void Enemy::setStance(const PlayerStance &val) {
  _stance = val;
}

inline void Enemy::setEscapeHole(const EscapeHole &val) {
  _escapeHole = val;
}

inline void Enemy::setDirection(const Direction &val) {
  _direction = val;
}

inline void Enemy::setPreferredDirection(const Direction &val) {
  _preferredDirection = val;
}

inline void Enemy::decrementDirectionCountdown(void) {
  --this->_directionCountdown;
}

inline void Enemy::decrementGoldCountdown(void) {
  --this->_goldCountdown;
}
