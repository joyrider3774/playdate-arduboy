...
extern uint8_t walkingFrame;
extern uint8_t waitingFrame;

uint8_t playerFacing = PLAYER_FACING_RIGHT;
boolean isGrounded = false;
const uint8_t gravity = 1;
int playerYVelocity = 0;

PROGMEM const uint8_t playerWalks[] = { 1, 2, 3, 2, 4, 5, 6, 5,};
PROGMEM const uint8_t playerWaiting[] = {0, 7, 0, 7, 0, 0, 0, 0, 0, 8, 9, 8, 0, 0, 0, 0, 1, 1, 1, 1, 0, 4, 4, 4, 4, 0, 0, 0, 7, 0, 7, 0, 0, 0, 0, 0};
