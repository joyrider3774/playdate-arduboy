...
const uintptr_t PROGMEM buyMenuItems[BUY_MENU_ITEMS_COUNT * BUY_MENU_ITEM_PROPS_COUNT] = {
    reinterpret_cast<uintptr_t>(grub_tiles),
    reinterpret_cast<uintptr_t>(grub_string),
    GRUB_PRICE,
    reinterpret_cast<uintptr_t>(shrimp_tiles),
    reinterpret_cast<uintptr_t>(shrimp_string),
    SHRIMP_PRICE,
    reinterpret_cast<uintptr_t>(proPole_tiles),
    reinterpret_cast<uintptr_t>(proPole_string),
    PRO_POLE_PRICE,
    reinterpret_cast<uintptr_t>(boatOar_tiles),
    reinterpret_cast<uintptr_t>(boatOars_string),
    OARS_PRICE
};
...
void Shop::renderBuy(uint8_t frame) {
    ...
    for (uint8_t i = 0; i < BUY_MENU_ITEMS_COUNT; ++i) {
        ...
        // price
        const int16_t price = static_cast<int16_t>(reinterpret_cast<uintptr_t>(pgm_read_ptr(buyMenuItems + i * BUY_MENU_ITEM_PROPS_COUNT + 2)));
